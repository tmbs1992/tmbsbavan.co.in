					   ...
					   <li><a href="about.html">About Us</a></li>
                        ...
                        <li class="dropdown submenu">
                            ...
                            <ul class="dropdown-menu other_dropdwn">
                                <li><a href="services.html">Matrimonial</a></li>
								<li><a href="services-2.html">Astrology</a></li>
                        ...
                        <li class="dropdown submenu">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a href="blog-2.html">Events/Registration </a></li>
								<li><a href="blog-2.html">Online Donation</a></li>
                            </ul>
                        </li>
        ...
        <div class="container">
            ...
            <div class="row about_row">
                <div class="who_we_area col-md-7 col-sm-6">
                    ...
                    <a href="about.html" class="button_all">Click Now</a>
                </div>
            ...
            <div class="row construction_iner">
                ...
                <div class="col-md-4 col-sm-6 construction">
                   ...
                   <div class="cns-content">
                        <i class="fa fa-keyboard-o" aria-hidden="true"></i>
                        <a href="#">Events</a>
                        <p>Lorem Ipsum is simply dummy text of the print-ing and typesetting industry. Lorem Ipsum has been the industry's standard dummy standard</p>
                   </div>
                </div>
            </div>
        </div>
            ...
            <div class="portfolio_inner_area">
                <div class="portfolio_filter">
                    <ul>
                        ...
                        <li data-filter=".photography"><a href="">Matrimonial</a></li>
                        <li data-filter=".branding"><a href="">Events</a></li>
                        <li data-filter=".webdesign"><a href="">Bussiness</a></li>
                        <li data-filter=".adversting"><a href="">Education</a></li>
                        <li data-filter=".painting"><a href="">Services</a></li>
                    </ul>
                </div>
                <div class="portfolio_item">
                   <div class="grid-sizer"></div>
                    ...
                    <div class="single_facilities col-xs-4 painting p0 photography branding">
                       <div class="single_facilities_inner">
                          	<img src="images/gallery/SV3.png" alt="">
                            <div class="gallery_hover">
                                <h4>Tmbsbavan</h4>
                                <ul>
                                    <li><a href="#"><i class="fa fa-link" aria-hidden="true"></i></a></li>
  ...
  <!-- blog area -->
    ...
    <section class="our_partners_area">
        <div class="container">
            <div class="tittle wow fadeInUp">
                <h2>Bussiness Ads</h2>
                <h4>~ Please contact Tmbsbavan for regarding your bussiness adversting to share your bussiness logo and bussiness card to help our community ~</h4>
            </div>
            <div class="partners">
    ...
    <footer class="footer_area">
        ...
        <div class="copyright_area">
           Copyright 2019 Tmbsbavan Designed by Vishal Joshi. All rights reserved.
        </div>
    </footer>
    <!-- End Footer Area -->
