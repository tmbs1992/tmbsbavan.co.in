...
//$query->execute(array(':first_name'=> $first_name, ':last_name'=> $last_name, ':Brahmin'=> $Brahmin, ':Birth_date'=> $Birth_date,':Gothra'=> $Gothra, ':Gender'=> $Gender, ':email'=> $email, ':password'=> $password,':phone'=> $Phone,':Village'=> $Village, ':City'=> $City, ':State'=> $State, ':PinCode'=> $PinCode));
