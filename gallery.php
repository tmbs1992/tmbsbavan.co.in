    ...
    <section class="blog_tow_area">
        <div class="container">
           <div class="row blog_tow_row">
                ...
                <div class="col-md-4 col-sm-6">
                    <div class="renovation">
                        <img src="images/blog/renovation/r4.jpg" alt="">
                        <div class="renovation_content">
                            <a class="clipboard" href="#"><i class="fa fa-clipboard" aria-hidden="true"></i></a>
                            <a class="tittle" href="#">Community Programs  </a>
                            <div class="date_comment">
                                <a href="#"><i class="fa fa-calendar" aria-hidden="true"></i>October 20, 2016</a>
                                <a href="#"><i class="fa fa-commenting-o" aria-hidden="true"></i>139</a>
                            </div>
                            <p></p>
                        </div>
                    </div>
                ...
                <div class="col-md-4 col-sm-6">
                    <div class="renovation">
                        <img src="images/blog/renovation/r3.jpg" alt="">
                        <div class="renovation_content">
                            <a class="clipboard" href="#"><i class="fa fa-clipboard" aria-hidden="true"></i></a>
                            <a class="tittle" href="#">Religious Ceremonies  </a>
                            <div class="date_comment">
                                <a href="#"><i class="fa fa-calendar" aria-hidden="true"></i>October 20, 2016</a>
                                <a href="#"><i class="fa fa-commenting-o" aria-hidden="true"></i>146</a>
                            </div>
                            <p></p>
                        </div>
                    </div>
                ...
                <div class="col-md-4 col-sm-6">
                    <div class="renovation">
                        <img src="images/blog/renovation/r2.jpg" alt="">
                        <div class="renovation_content">
                            <a class="clipboard" href="#"><i class="fa fa-clipboard" aria-hidden="true"></i></a>
                            <a class="tittle" href="#">Upnayan Sanskar </a>
                            <div class="date_comment">
                                <a href="#"><i class="fa fa-calendar" aria-hidden="true"></i>October 20, 2016</a>
                                <a href="#"><i class="fa fa-commenting-o" aria-hidden="true"></i>175</a>
                            </div>
                            <p></p>
                        </div>
                    </div>
                ...
                <div class="col-md-4 col-sm-6">
                    <div class="renovation">
                        <img src="images/blog/renovation/r5.jpg" alt="">
                        <div class="renovation_content">
                            <a class="clipboard" href="#"><i class="fa fa-clipboard" aria-hidden="true"></i></a>
                            <a class="tittle" href="#">Success Events </a>
                            <div class="date_comment">
                                <a href="#"><i class="fa fa-calendar" aria-hidden="true"></i>October 20, 2016</a>
                                <a href="#"><i class="fa fa-commenting-o" aria-hidden="true"></i>104</a>
                            </div>
                            <p></p>
                        </div>
                    </div>
                ...
                <div class="col-md-4 col-sm-6">
                    <div class="renovation">
                        ...
                        <div class="renovation_content">
                            <a class="clipboard" href="#"><i class="fa fa-clipboard" aria-hidden="true"></i></a>
                            <a class="tittle" href="#">Social Work</a>
                            <div class="date_comment">
                                <a href="#"><i class="fa fa-calendar" aria-hidden="true"></i>October 20, 2016</a>
                                <a href="#"><i class="fa fa-commenting-o" aria-hidden="true"></i>178</a>
                            </div>
                            <p></p>
                        </div>
                    </div>
                ...
                <div class="col-md-4 col-sm-6">
                    <div class="renovation">
                        ...
                        <div class="renovation_content">
                            <a class="clipboard" href="#"><i class="fa fa-clipboard" aria-hidden="true"></i></a>
                            <a class="tittle" href="#">Community Work</a>
                            <div class="date_comment">
                                <a href="#"><i class="fa fa-calendar" aria-hidden="true"></i>October 20, 2016</a>
                                <a href="#"><i class="fa fa-commenting-o" aria-hidden="true"></i>107</a>
                            </div>
                            <p></p>
                        </div>
                    </div>
                ...
                <div class="col-md-4 col-sm-6">
                    <div class="renovation">
                        ...
                        <div class="renovation_content">
                            <a class="clipboard" href="#"><i class="fa fa-clipboard" aria-hidden="true"></i></a>
                            <a class="tittle" href="#">Shivaratri Puja</a>
                            <div class="date_comment">
                                <a href="#"><i class="fa fa-calendar" aria-hidden="true"></i>February 21, 2020</a>
                                <a href="#"><i class="fa fa-commenting-o" aria-hidden="true"></i>99</a>
                            </div>
                            <p></p>
                        </div>
                    </div>
                ...
                <div class="col-md-4 col-sm-6">
                    <div class="renovation">
                        ...
                        <div class="renovation_content">
                            <a class="clipboard" href="#"><i class="fa fa-clipboard" aria-hidden="true"></i></a>
                            <a class="tittle" href="#">Parashurama Jayanti </a>
                            <div class="date_comment">
                                <a href="#"><i class="fa fa-calendar" aria-hidden="true"></i>April 25, 2020</a>
                                <a href="#"><i class="fa fa-commenting-o" aria-hidden="true"></i>149</a>
                            </div>
                            <p></p>
                        </div>
                    </div>
		...
		<!-- End blog area -->
		<p><b>Notice </b>: If you have any <b>Tmbsbavan</b> Events Photographs Please share with us we will display here. <a href="contact.php"> Click Here </a></p>
   </div>
</section>
<!-- End blog-2 area -->
    <!-- Footer Area -->
